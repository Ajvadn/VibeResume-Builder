...
import { Download, Play, ZoomIn, ZoomOut, FileUp, Home } from 'lucide-react';
...
export const Toolbar: React.FC<ToolbarProps> = ({ onDownload, onImport, isGenerating }) => {
    return (
        <div className="h-20 flex items-center justify-between px-8 no-print border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
            ...
            <div className="flex items-center gap-4">
                ...
                <Button onClick={onDownload} variant="outline" className="border-purple-500/30 hover:bg-purple-500/10 hover:border-purple-500/50 text-purple-300 hover:text-purple-200 hover:shadow-[0_0_15px_rgba(168,85,247,0.15)] transition-all duration-300">
